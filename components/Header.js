            ...
            <div className="row  ">
              ...
              >
                <div className="input-group">
                  ...
                  >
                    <div className="row search-type-row">

                      {autocomplete.length ? (
                        autocomplete.map((suggestion) => {
                          const wordLimit = 40;
                          let image = ""
                          let productTitle = suggestion.product_name;
                          let productLength = productTitle.length;

                          if (parseInt(productLength) > wordLimit) {
                            productTitle = productTitle.slice(0, wordLimit) + "...";
                          }

                          switch (suggestion.type) {
                            case "bed":
                              image = suggestion.images[0].color1.base_url;
                              break;
                            case "headboard":
                            ...
                            default:
                              image = "/assets/images/DivanBedsicon/Group 538.png"
                              break;
                          ...
                          return (
                            <div className="col-md-4 p-0" onClick={() =>
                              handleRoute(
                                suggestion.type,
                              ...
                              <div className="searchitems-box">
                                <ul>
                                  <li className="col-2 p-0"> <Image src={image} width={100} height={100} /></li>
                                  <li className="col-10"><h4 className="suggestion-title result-title">{productTitle}</h4>

                                    <div className="suggestion-price price">
                                      <span className="woocommerce-Price-amount amount">

                                        <span claclassNamess="woocommerce-Price-currencySymbol">£</span>{suggestion.price}
                                      </span>
                                    </div>
                                  </li>
                                </ul>
                    ...
                    <li className="dropdown position-static">
                      ...
                      <ul className="mega-menu d-block">
                        <li className="d-flex">
                          ...
                          <ul className="d-block">
                            <li className="title">
                              <a href="/sofa/fabricsofa" style={{ color: "#262884" }}>
                                <b>Fabric Sofa</b>
                              </a>
                            </li>
                            <li>
                          ...
                          <ul className="d-block">
                            <li className="title1">
                              <a href="/allbed/leather-bed" style={{ color: "#262884" }}>
                                <b>Leather beds</b>
                              </a>
                            </li>
                            <li className="title1">
                            ...
                            <li className="title1">
                              <a href="/allbed/storage-bed" style={{ color: "#262884" }}>
                                <b>Storage Bed</b>
                              </a>
                            </li>
                          </ul>
                    ...
                    <li className="dropdown position-static">
                      ...
                      <ul className="mega-menu d-block">
                        <li className="d-flex">
                          ...
                          <ul className="d-block">
                            <li className="title">
                              <Link href="/livingroom/chairs" style={{ color: "#262884" }}>
                                <b>Chairs</b>
                              </Link>
                            </li>
                            <li className="title">
                              <Link href="/livingroom/tables" style={{ color: "#262884" }}>
                                <b>Tables</b>
                              </Link>
                            </li>
                            <li>
                    ...
                    <li className="dropdown position-static">
                      ...
                      <ul className="mega-menu d-block">
                        <li className="d-flex">
                          ...
                          <ul className="d-block">
                            <li className="title">
                              <a href="/diningset/diningtableset" style={{ color: "#262884" }}>
