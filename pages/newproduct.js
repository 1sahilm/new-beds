...
function NewProduct({ response }) {
  ...
  useEffect(() => {
    ...
    setImage(divanBedSize[0].images[0].color1.base_url);
  }, [response]);
  useEffect(() => {
    setTotal(
      parseInt(qty) *
                ...
                return (
                  <div className="product productNew sliderProduct">
                    <div className="thumb">
                      ...
                      {/* {</a> */} 
                      <button onClick={()=>router.push(`/newproduct?title=${bed.product_name}`)} className="image">
                        <Image
                          width={378}
                          height={128}
                          src={bed.images[0].color1.base_url}
                    ...
                    <div className="best-seller mb-6 mt-8 text-center">
                      <button onClick={()=>router.push(`/newproduct?title=${bed.product_name}`)}>BUY NOW</button>
                    </div>
