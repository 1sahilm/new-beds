          ...
          <div className="row">
            <div className="size-box">
              <div className="single-box category-icon">
                <a href="/diningset/2seaterdiningset">
              ...
              <div className="single-box category-icon" >
                <a href="/diningset/3seaterdiningset">
              ...
              <div className="single-box category-icon">
                <a href="/diningset/4seaterdiningset">
                  <Image
                    width={140}
                    height={128}
                    alt="BedsDivan"
              ...
              <div className="single-box category-icon">
                <a href="/diningset/6seaterdiningset">
                  <Image
                    width={140}
                    height={128}
                    alt="BedsDivan"
              ...
              <div className="single-box category-icon">
                <a href="/diningset/8seaterdiningset">
                  <Image
                    width={140}
                    height={128}
                    alt="BedsDivan"
...
export async function getServerSideProps(context) {
  ...
  const data = await axios.post(
   ...
   `${process.env.BASE_URL}/api/diningset/getbeds`,
    {
      method: "category",
      value: 'SideBoard',
    }
