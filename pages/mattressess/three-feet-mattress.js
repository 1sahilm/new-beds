          ...
          <div className="row">
            <div className="size-box">
              <div className="single-box category-icon">
                <a href="/mattressess/two-feet-mattress">
              ...
              <div className="single-box category-icon" >
                <a href="/mattressess/three-feet-mattress">
              ...
              <div className="single-box category-icon">
                <a href="/mattressess/four-feet-mattress">
                  <Image
                    width={140}
                    height={128}
                    alt="BedsDivan"
              ...
              <div className="single-box category-icon">
                <a href="/mattressess/four-six-feet-mattress">
                  <Image
                    width={140}
                    height={128}
                    alt="BedsDivan"
              ...
              <div className="single-box category-icon">
                <a href="/mattressess/five-feet-mattress">
                  <Image
                    width={140}
                    height={128}
                    alt="BedsDivan"
              ...
              <div className="single-box category-icon">
                <a href="/mattressess/six-feet-mattress">
                  <Image
                    width={250}
                    height={50}
                    alt="BedsDivan"
