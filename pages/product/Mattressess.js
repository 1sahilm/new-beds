...
<div className="single-box">
                               <a href="/mattressess/three-feet-mattress"> <Image width={100} height={120} src="/assets/images/DivanBedsicon/Group 477.svg" alt="Product" /></a>
                            ...
                            <div className="single-box">
                               <a href="/mattressess/four-feet-mattress"> <Image width={100} height={120} src="/assets/images/DivanBedsicon/Group 478.svg" alt="Product" /></a>
                                <p className="text-center  mt-2" style={{color:"#222178" }}> <b>Small Double</b></p>
                            </div>


                            <div className="single-box">
                                <a href="/mattressess/four-six-feet-mattress"><Image width={100} height={120} src="/assets/images/DivanBedsicon/Group 479.svg"  alt="Product"/></a>
                                <p className="text-center  mt-2" style={{color:"#222178" }}> <b>Double</b></p>
                            </div>

                            <div className="single-box">
                                <a href="/mattressess/five-feet-mattress"><Image width={100} height={120} src="/assets/images/DivanBedsicon/Group 480.svg" alt="Product" /></a>
                            ...
                            <div className="single-box">
                                <a href="/mattressess/six-feet-mattress"><Image width={100} height={120} src="/assets/images/DivanBedsicon/Group 481.svg" alt="Product"/></a>
                                <p className="text-center mt-2" style={{color:"#222178" }}>
                                  <b> Super King</b>
                                </p>
                            </div>
...
export async function getServerSideProps(context) {
  ...
  const data = await axios.post(
    `${process.env.BASE_URL}/api/mattress`,
  );
