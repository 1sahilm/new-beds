...
<div className="single-box">
                               <a href="/headboard/three-feet-headboard"> <Image width={100} height={120} src="/assets/images/DivanBedsicon/Group 477.svg" alt="Product" /></a>
                                 
                                <p className="text-center  mt-2" style={{color:"#222178" }}> <b> Single(3FT) </b></p>
                                 
</div>

                            <div className="single-box">
                               <a href="/headboard/four-feet-headboard"> <Image width={100} height={120} src="/assets/images/DivanBedsicon/Group 478.svg" alt="Product" /></a>
                                <p className="text-center  mt-2" style={{color:"#222178" }}> <b> Small Double(4FT)</b></p>
                            </div>


                            <div className="single-box">
                                <a href="/headboard/four-six-feet-headboard"><Image width={100} height={120} src="/assets/images/DivanBedsicon/Group 479.svg"  alt="Product"/></a>
                                <p className="text-center  mt-2" style={{color:"#222178" }}> <b> Double(4FT 6") </b></p>
                            </div>

                            <div className="single-box">
                                <a href="/headboard/five-feet-headboard"><Image width={100} height={120} src="/assets/images/DivanBedsicon/Group 480.svg" alt="Product" /></a>
                            ...
                            <div className="single-box">
                                <a href="/headboard/six-feet-headboard"><Image width={100} height={120} src="/assets/images/DivanBedsicon/Group 481.svg" alt="Product"/></a>
                                <p className="text-center mt-2" style={{color:"#222178" }}>
                                  <b> Super King</b>
                                </p>
                            </div>
...
export async function getServerSideProps(context) {
  ...
  const data = await axios.post(
    `${process.env.BASE_URL}/api/headboard`,
  );
